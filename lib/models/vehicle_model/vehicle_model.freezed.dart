...
class _$_VehicleModel implements _VehicleModel {
  ...
  @override
  String toString() {
    return 'VehicleModel(chrono: $chrono, note: $note, updated_at: $updated_at, commercial_name: $commercial_name, created_at: $created_at, delivery_date: $delivery_date, id: $id, mileage: $mileage, procedure_ve: $procedure_ve, sold_at: $sold_at, collection_date: $collection_date, first_circulation: $first_circulation, registration: $registration, serial_number: $serial_number, current_status: $current_status, expertise: $expertise, info: $info, owner_id: $owner_id)';
  }
...
abstract class _VehicleModel implements VehicleModel {
  const factory _VehicleModel(
      ...
      required final String owner_id}) = _$_VehicleModel;
