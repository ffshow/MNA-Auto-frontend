...
class OwnerService{
  ...
  /// 
  /// Path /api/owner
  Future<OwnerModel> postApiOwner() async{
  ...
  /// 
  /// Path /api/owner_list
  Future<List<OwnerModel>> getApiOwnerList({ int? page, int? per_page, String? sort_by, bool? descending, }) async{
  ...
  Future<List<OwnerModel>> postApiOwnerImport() async{
    final Response response = await _dio.post(
      "/api/owner_import",
      queryParameters: <String, dynamic>{},
    );
  ...
  /// 
  /// Path /api/owner/{id}
  Future<OwnerModel> getApiOwner(String id, ) async{
    final Response response = await _dio.get(
      "/api/owner/$id",
      queryParameters: <String, dynamic>{},
    );
  ...
  /// 
  /// Path /api/owner/{id}
  Future<OwnerModel> putApiOwner(String id, ) async{
