...
class VehicleService{
  ...
  /// 
  /// Path /api/vehicle/{id}
  Future<VehicleModel> putApiVehicle(String id, ) async{
  ...
  /// 
  /// Path /api/vehicle/{id}
  Future<VehicleModel> getApiVehicle(String id, ) async{
  ...
  Future<List<VehicleModel>> getApiVehicleList({ int? page, int? per_page, String? sort_by, bool? descending, }) async{
    final Response response = await _dio.get(
      "/api/vehicle_list",
      queryParameters: <String, dynamic>{
  ...
  /// 
  /// Path /api/vehicle
  Future<VehicleModel> postApiVehicle() async{
  ...
  Future<List<VehicleModel>> postApiVehicleImport() async{
    final Response response = await _dio.post(
      "/api/vehicle_import",
      queryParameters: <String, dynamic>{},
    );
