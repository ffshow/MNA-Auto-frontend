...
class GarageService{
  ...
  Future<List<GarageModel>> postApiGarageImport() async{
  ...
  Future<List<GarageModel>> getApiGarageList({ int? page, int? per_page, String? sort_by, bool? descending, }) async{
  ...
  /// 
  /// Path /api/garage
  Future<GarageModel> postApiGarage() async{
    final Response response = await _dio.post(
      "/api/garage",
      queryParameters: <String, dynamic>{},
    );
  ...
  /// 
  /// Path /api/garage/{id}
  Future<GarageModel> getApiGarage(String id, ) async{
    final Response response = await _dio.get(
      "/api/garage/$id",
      queryParameters: <String, dynamic>{},
    );
  ...
  /// 
  /// Path /api/garage/{id}
  Future<GarageModel> putApiGarage(String id, ) async{
